...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SLSH, KC_EQL,  KC_BSPC, KC_DEL,
        KC_TAB,  KC_Q,             KC_U,    KC_COMM, KC_DOT,  KC_F,    KC_W,    KC_R,    KC_Y,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_HOME,
        KC_CAPS,                            KC_O,    KC_MINS, KC_K,    KC_T,    KC_N,    KC_S,    KC_H,    KC_QUOT, KC_ENT,  KC_END,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_SCLN, KC_G,    KC_D,    KC_M, KC_J,  KC_B, KC_RSFT, KC_UP,   KC_INS,
...
uint16_t keys[4] = {KC_L, KC_E, KC_I, KC_A};
